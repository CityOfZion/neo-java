...
public enum OpCode {
	...
	/** PUSH0. An empty array of bytes is pushed onto the stack. */
	PUSH0(0x00),
	...
	/**
	 * return the OpCode, or throw an exception if there is no match.
	 *
	 * @param typeByte
	 *            type type byte.
	 * @return the OpCode, or throw an exception if there is no match.
	 */
	public static OpCode valueOfByte(final byte typeByte) {
		for (final OpCode it : OpCode.values()) {
	...
	/**
	 * the byte representing the OpCode.
	 */
...
// PUSHF = PUSH0,
// PUSHBYTES1 = 0x01, // 0x01-0x4B The next opcode bytes is data to be pushed
// onto the stack
// PUSHBYTES75 = 0x4B,
// PUSHDATA1 = 0x4C, // The next byte contains the number of bytes to be pushed
// onto the stack.
// PUSHDATA2 = 0x4D, // The next two bytes contain the number of bytes to be
// pushed onto the stack.
// PUSHDATA4 = 0x4E, // The next four bytes contain the number of bytes to be
// pushed onto the stack.
...
// // Stack
// DUPFROMALTSTACK = 0x6A,
// TOALTSTACK = 0x6B, // Puts the input onto the top of the alt stack. Removes
...
// TUCK = 0x7D, // The item at the top of the stack is copied and inserted
...
// LEFT = 0x80, // Keeps only characters left of the specified point in a
// string.
// RIGHT = 0x81, // Keeps only characters right of the specified point in a
// string.
...
// NOT = 0x91, // If the input is 0 or 1, it is flipped. Otherwise the output
// will be 0.
...
// WITHIN = 0xA5, // Returns 1 if x is within the specified range
